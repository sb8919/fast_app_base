...
import 'package:fast_app_base/screen/main/tab/home/w_ban_account.dart';
      ...
      child: Stack(
        children: [
          RefreshIndicator(
            ...
            onRefresh: () async{
              await sleepAsync(Duration(milliseconds: 500));
            ...
            ).animate().slideY(duration:NumDurationExtension(1000).ms).fadeIn(),
          ),
          TossAppbar(),
        ],
      ),
